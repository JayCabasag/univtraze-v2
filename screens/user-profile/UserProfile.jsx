      ...
      <KeyboardAvoidingView style={{ backgroundColor: '#E1F5E4', height: '100%' }}>
        ...
        <ScrollView>
          ...
          <View style={{ width: '100%', alignItems: 'center', borderRadius: 15 }}>
            ...
            />
            {hasMiddleNameError && (
              <Text style={styles.errorLabel}>*{formik.errors.middleName}</Text>
            )}
          </View>
          ...
          <View style={{ width: '100%', alignItems: 'center', borderRadius: 15 }}>
            ...
            />
            {hasPhoneNumberError && (
              <Text style={styles.errorLabel}>*{formik.errors.phoneNumber}</Text>
            )}
          </View>
          ...
          <View style={{ width: '100%', alignItems: 'center', borderRadius: 15 }}>
            ...
            {hasDateOfBirthError && (
              <Text style={styles.errorLabel}>*{formik.errors.dateOfBirth}</Text>
            )}
          </View>
