...
const SignUpCredentialsDocuments = ({ navigation, route }) => {
  ...
  const updateUserType = async () => {
    ...
    await axios.post(`${PRODUCTION_SERVER}/user/updateUserType`, data, config).then((response) => {
  ...
  const handleImageUploads = async (profilePhoto, frontIdPhoto, backIdPhoto) => {
    ...
    await axios
      .post(`${PRODUCTION_SERVER}/uploadUserBase64Image`, {
        image: backIdPhoto,
      })
      .then(function (response) {
  ...
  const handleAddStudentDetails = async (
    ...
    await axios
      .post(`${PRODUCTION_SERVER}/user/addStudentDetails`, data, config)
      .then((response) => {
        const success = response.data.success;
  ...
  const handleAddEmployeeDetails = async (
    ...
    await axios
      .post(`${PRODUCTION_SERVER}/user/addEmployeeDetails`, data, config)
      .then((response) => {
        const success = response.data.success;
  ...
  const handleAddEVisitorDetails = async (
    ...
    await axios
      .post(`${PRODUCTION_SERVER}/user/addVisitorDetails`, data, config)
      .then((response) => {
        const success = response.data.success;
