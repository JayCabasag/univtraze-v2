		...
		<SafeAreaView>
			...
			<View style={styles.container}>
				...
				<View style={styles.bodyContainer}>
					...
					>
						<Text style={{ fontSize: 25, paddingBottom: 10, color: '#000000', fontWeight: '700', marginLeft: 0, marginRight: 'auto' }}>History</Text>
						<TouchableWithoutFeedback
							onPress={() => {
					...
					<ScrollView>
						...
						>
							...
							>
								...
								<DataTable.Title><Text style={{ fontSize: 14, fontWeight: 'bold' }}>Temp</Text></DataTable.Title>
							...
							</DataTable.Header>
							{
								allTemperatureHistory === undefined ?
									...
									allTemperatureHistory.map((tempHistory) => {
										return <DataTable.Row key={tempHistory.id} onPress={() => {
											viewHistoryData(tempHistory.id, tempHistory.room_id, tempHistory.room_number, tempHistory.building_name, tempHistory.room_name, tempHistory.temperature, tempHistory.createdAt)
										}}>
